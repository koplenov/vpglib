...
#define CONFIGURE_ARGS "--enable-thread-safety --enable-nls --with-ldap --with-ssl=openssl --with-uuid --with-libxml --with-libxslt --with-lz4 --with-icu --with-tcl --with-perl --with-python"
...
#define PACKAGE_STRING "PostgreSQL 14.13"
...
#define PG_VERSION "14.13"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 140013

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 14.13, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
