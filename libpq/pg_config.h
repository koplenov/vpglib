...
#define CONFIGURE_ARGS "--enable-thread-safety --enable-nls --with-ldap --with-openssl --with-uuid --with-libxml --with-libxslt --with-icu --with-tcl --with-perl --with-python"
...
#define PACKAGE_STRING "PostgreSQL 13.16"
...
#define PG_VERSION "13.16"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 130016

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 13.16, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
